...
<html lang="en">
    <head>
        ...
        <title> News | Administrar Sub Categorias</title>
...
<td colspan="7" align="center"><h3 style="color:red"> Ningún record fue encontrado </h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i>  
Subcategorías eliminadas</h4>
